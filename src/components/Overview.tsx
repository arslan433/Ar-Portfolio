...
export default function Overview() {
    return (
        <>
            <Header />
            <div className="flex max-sm:mx-3 justify-center ">
                <div className="flex flex-col mt-20">
                    <div className="max-w-sm rounded-md bg-whte/10 p-5 backdirop-blur-md text-center items-center" id="">
                        <div className="justify-items-center">
                            <h1 className="text-3xl font-bold pb-4 max-sm:w-[307px]"> Hi, I am <i>Arslan.M</i> </h1>
                            <Image
