              ...
              onInit={(typewriter) => {
                typewriter
                  ...
                  .typeString(
                    ...
                    `  <span class="text-cyan-400">skills</span>: [<span class="text-green-400">'React'</span>, <span class="text-green-400">'NextJS'</span>, <span class="text-green-400">'Redux'</span>, <span class="text-green-400">'Express'</span>,<br>` +
                    `    <span class="text-green-400">'NestJS'</span>, <span class="text-green-400">'MySql'</span>, <span class="text-green-400">'MongoDB'</span>, <span class="text-green-400">'Docker'</span>, <span class="text-green-400">'AWS'</span>],<br>` +
